    ...
    public partial class Login : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            TwinfieldSession.LogonResult logonResult
                = HoursAccounting.TwfSession.Logon(txtUser.Text, txtPassword.Text, txtOrganisation.Text, out nextAction, out cluster);
            ...
            if (logonResult == HoursAccountability.TwinfieldSession.LogonResult.Ok)
            {
                ...
                {
                    HoursAccounting.SessionId = HoursAccounting.TwfSession.HeaderValue.SessionID;
        ...
        private void Login_Load(object sender, EventArgs e)
        {
            ...
            chkRemember.Checked = _remembered;
        }
    }
}
